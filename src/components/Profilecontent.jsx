            ...
            <div ref={resumeRef} className="relative bg-white p-6 sm:p-8 rounded-xl shadow-lg">
              ...
              <div className="mb-8 border-b pb-6 border-gray-100">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                  <div className="mb-4 md:mb-0">
                    <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-2">Mert Batut</h1>
                  ...
                  <div className="flex flex-col space-y-2">
                    ...
                    <div className="flex items-center">
                      ...
                      <a href="mailto:mertbatut@gmail.com" className="hover:text-[#2dd4bf] transition-colors">mertbatut@gmail.com</a>
                    </div>
                    <div className="flex items-center">
                    ...
                    <div className="flex items-center">
                      ...
                      <a href="https://www.mertbatut.com.tr/" target="_blank" rel="noopener noreferrer" className="hover:text-[#2dd4bf] transition-colors">www.mertbatut.com.tr</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="mb-8">
                    ...
                    <div className="mb-4">
                      <div className="bg-gray-50 p-4 rounded-lg border border-gray-100 hover:border-[#CBF281]/50 transition-all duration-300 hover:shadow-md">
                        ...
                        <p className="text-sm text-gray-600">{t('profile.recentWork')}</p>
                      </div>
                    </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="flex items-center bg-[#f0f9ff] p-3 rounded-md hover:bg-[#e0f5ff] transition duration-300">
