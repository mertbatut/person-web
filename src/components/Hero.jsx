        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-6 lg:gap-12">
          ...
          >
            ...
            >
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
              >
                <span className='no-underline'>{t('hero.viewProjects')}</span>
            ...
            >
              ...
              >
                <span className="text-[#CBF281] font-semibold">3+</span> {t('hero.experience')}
              </motion.div>
              <motion.div 
                className="bg-white/5 backdrop-blur-md px-4 py-2 rounded-full text-sm text-white/80 border border-white/10"
                whileHover={{ scale: 1.05, backgroundColor: 'rgba(255, 255, 255, 0.1)' }}
              >
                <span className="text-[#CBF281] font-semibold">20+</span> {t('hero.projects')}
              </motion.div>
              <motion.div 
                className="bg-white/5 backdrop-blur-md px-4 py-2 rounded-full text-sm text-white/80 border border-white/10"
                whileHover={{ scale: 1.05, backgroundColor: 'rgba(255, 255, 255, 0.1)' }}
              >
                <span className="text-[#CBF281] font-semibold">10+</span> {t('hero.technologies')}
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative mx-auto max-w-md">
              ...
              {/* Skill cards floating around the image */}
              <motion.div 
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('hero.frontendDev')}</p>
                    <p className="text-gray-900 text-sm font-bold">{t('hero.developer')}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('hero.backendDev')}</p>
                    <p className="text-gray-900 text-sm font-bold">{t('hero.developer')}</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-white font-medium">{t('hero.webDev')}</p>
                    <p className="text-gray-300 text-sm">{t('hero.development')}</p>
                  </div>
                </div>
              </motion.div>
            </div>
